...
plot(fev12$DateTime, fev12$Voltage, type="l", xlab ="datetime", ylab = "Voltage" )
...
plot(fev12$DateTime, fev12$Global_reactive_power, type="l", xlab ="datetime", ylab = "Global_Reactive_Power" )
